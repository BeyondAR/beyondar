...
//		go9.setName("Creature 4");
		...
		GeoObject go_1 = new GeoObject(7l);
		go_1.setGeoPosition(41.39636d, 2.173684d);
		go_1.setImageResource(R.drawable.creature_2);
		go_1.setName("Creature 2");

		GeoObject go_2 = new GeoObject(8l);
		go_2.setGeoPosition(41.394783, 2.173684d);
		go_2.setImageResource(R.drawable.rectangle);
		go_2.setName("Object 8");

		GeoObject go_3 = new GeoObject(9l);
		go_3.setGeoPosition(41.397519d, 2.179048d);
		go_3.setImageResource(R.drawable.creature_4);
		go_3.setName("Creature 4");
		
		sharedWorld.addBeyondarObject(go_1);
		sharedWorld.addBeyondarObject(go_2);
		sharedWorld.addBeyondarObject(go_3);
