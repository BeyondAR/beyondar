...
import com.beyondar.android.util.LayoutToImageConvertor;
...
public class CustomWorldHelper {
	...
	public static World generateObjects(Context context) {
		...
		go7.setImageResource(R.drawable.splash);
	...
	public static World generateObjectsWithViewMarkers(Context context, LayoutInflater inflater) {
		if (sharedWorld != null){
			return sharedWorld;
		}
		sharedWorld = new World(context);
		...
		try {
			...
			String uri = LayoutToImageConvertor.convert(context, view, "creature_5.png");
			go5.setImageUri(uri);
